...
export class ReservationStatesService {
  constructor(@InjectRepository(ReservationState) private reservationStatesRepository: Repository<ReservationState>){}

  create(createReservationStateInput: CreateReservationStateInput):Promise<ReservationState>{
    const newReservationState = this.reservationStatesRepository.create(createReservationStateInput); 
  ...
  async update(id: string, updateReservationStateInput: UpdateReservationStateInput):Promise<ReservationState> {
    const updatedReservationState = await this.reservationStatesRepository.preload({
      id: id,
