...
const RegisterForm: React.FC = () => {
  ...
  const formik: FormikProps<MyRegisterFormValues> =
    useFormik<MyRegisterFormValues>({
      initialValues: {
        regFname: "",
        regLname: "",
        regEmail: "",
      ...
      validationSchema: YUP.object({
        ...
        repeatRegPass: YUP.string().oneOf(
          [YUP.ref("regPass"), null],
    ...
    <RegSection>
      <div className="wrap">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          />
          {formik.touched.regFname && formik.errors.regFname ? (
            <p className="error">{formik.errors.regFname}</p>
          ) : null}
          <Input
            id="regLname"
            name="regLname"
          ...
          />
          {formik.touched.regLname && formik.errors.regLname ? (
            <p className="error">{formik.errors.regLname}</p>
          ) : null}
          <Input
            id="regEmail"
            name="regEmail"
          ...
          />
          {formik.touched.regEmail && formik.errors.regEmail ? (
            <p className="error">{formik.errors.regEmail}</p>
          ) : null}
          <Select
            id="regStatus"
            name="regStatus"
          ...
          />
          {formik.touched.regStatus && formik.errors.regStatus ? (
            <p className="error">{formik.errors.regStatus}</p>
          ) : null}
          <Input
            id="regNumber"
            name="regNumber"
          ...
          {formik.touched.regNumber && formik.errors.regNumber ? (
            <p className="error">{formik.errors.regNumber}</p>
          ) : null}
          <Input
            id="regPass"
            name="regPass"
          ...
          />
          {formik.touched.regPass && formik.errors.regPass ? (
            <p className="error">{formik.errors.regPass}</p>
          ) : null}
          <Input
            id="repeatRegPass"
            name="repeatRegPass"
          ...
          />
          {formik.touched.repeatRegPass && formik.errors.repeatRegPass ? (
            <p className="error">{formik.errors.repeatRegPass}</p>
          ) : null}
          <StyledButton
            type="submit"
            text="Create Account"
