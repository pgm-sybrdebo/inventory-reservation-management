...
const DashboardUsers = () => {
  ...
  const [getUsersByLastNameWithPagination, { error, loading, data }] =
    useLazyQuery(GET_ALL_USERS_BY_LAST_NAME_WITH_PAGINATION);
